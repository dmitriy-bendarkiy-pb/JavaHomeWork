package com.pb.bendarskiy.hw12;


import hw11.PhoneItem;
import hw11.PhoneItemField;
...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        phoneBook.add(new PhoneItem("Name 3", formatter.parse("01.01.2000"), new ArrayList<>(Arrays.asList("111-000-000", "222-000-000", "333-000-000")), "Address3", Calendar.getInstance().getTimeInMillis()));
        phoneBook.add(new PhoneItem("Name 1", formatter.parse("03.03.2002"), new ArrayList<>(Arrays.asList("000-000-333", "000-000-111", "000-000-222")), "Address1check", Calendar.getInstance().getTimeInMillis()));
        phoneBook.add(new PhoneItem("Name 2", formatter.parse("02.02.2001"), new ArrayList<>(Arrays.asList("000-222-000", "000-333-000", "000-111-000")), "Address2", Calendar.getInstance().getTimeInMillis()));
        ...
        System.out.println("PhoneBook (removed phone item with name \"NameToRemove\"): ");
        System.out.println(phoneBook);
        System.out.println();
        ...
        PhoneItem phoneItemWithIndex1Edited = new PhoneItem("Name 3", formatter.parse("01.01.2000"), new ArrayList<>(Arrays.asList("111-000-000", "222-000-000", "333-000-000")), "Address3check", Calendar.getInstance().getTimeInMillis());
        ...
        System.out.println("PhoneBook from file: ");
        System.out.println(phoneBook.readFromFile());
        System.out.println();

        System.out.println("Before editing by name: ");
        System.out.println(phoneBook);
        PhoneItem editedPhoneItem = new PhoneItem("Name 3", formatter.parse("04.04.2004"), new ArrayList<>(Arrays.asList("121-000-000", "222-000-000", "333-000-000")), "Address3edited", Calendar.getInstance().getTimeInMillis());
        phoneBook.editByName("Name 3", editedPhoneItem);
