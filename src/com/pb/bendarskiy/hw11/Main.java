package com.pb.bendarskiy.hw11;
...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        phoneBook.add(new PhoneItem("Name 1", formatter.parse("03.03.2002"), new ArrayList<>(Arrays.asList("000-000-333", "000-000-111", "000-000-222")), "Address1", Calendar.getInstance().getTimeInMillis()));
        ...
        PhoneItem phoneItemWithIndex1Edited = new PhoneItem("Name 3", formatter.parse("01.01.2000"), new ArrayList<>(Arrays.asList("111-000-000", "222-000-000", "333-000-000")), "NewAddress", Calendar.getInstance().getTimeInMillis());
