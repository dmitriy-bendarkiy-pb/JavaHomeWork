package com.pb.bendarskiy.hw14;
...
public class Server {
    ...
    static class Receiver implements Runnable {
        static private final ConcurrentLinkedQueueString messages = new ConcurrentLinkedQueue();
    ...
    static class Sender implements Runnable {
        private static final ListReceiver receivers = new ArrayList();
